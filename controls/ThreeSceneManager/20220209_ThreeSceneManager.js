                ...
                )
{
    ...
    return Control.extend('wohland.de.ThreeJS_SceneManager.controls.ThreeSceneManager.ThreeSceneManager.js',
    {
        metadata: 
        {
            properties:
...
//          Texturen für Materialien
            const texLoader = new THREE.TextureLoader();
            const mat1 = new THREE.MeshBasicMaterial({color: 0xffffff, map: texLoader.load('assets/img/HotMocka-CT-060-033_1_01.jpg')});
            const mat2 = new THREE.MeshBasicMaterial({color: 0xffffff, map: texLoader.load('assets/img/HotMocka-CT-060-033_1_01.jpg')});
...
//          Rueckwand
            const rueckwandgeometry       = new THREE.BoxGeometry( 1, 200, 150 )                       
            const rueckwandmesh           = new THREE.Mesh( rueckwandgeometry, material );
